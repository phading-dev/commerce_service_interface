...
export function newProcessPayoutStripeTransferDisabledNotifyingTaskRequest(
  body: ProcessPayoutStripeTransferDisabledNotifyingTaskRequestBody,
): ClientRequestInterface<ProcessPayoutStripeTransferDisabledNotifyingTaskResponse> {
  return {
    descriptor: PROCESS_PAYOUT_STRIPE_TRANSFER_DISABLED_NOTIFYING_TASK,
    body,
  };
}

export function newListPayoutStripeTransferDisabledNotifyingTasksRequest(
  body: ListPayoutStripeTransferDisabledNotifyingTasksRequestBody,
): ClientRequestInterface<ListPayoutStripeTransferDisabledNotifyingTasksResponse> {
  return {
    descriptor: LIST_PAYOUT_STRIPE_TRANSFER_DISABLED_NOTIFYING_TASKS,
    body,
  };
}

export function newProcessPayoutStripeTransferSuccessNotifyingTaskRequest(
  body: ProcessPayoutStripeTransferSuccessNotifyingTaskRequestBody,
): ClientRequestInterface<ProcessPayoutStripeTransferSuccessNotifyingTaskResponse> {
  return {
    descriptor: PROCESS_PAYOUT_STRIPE_TRANSFER_SUCCESS_NOTIFYING_TASK,
    body,
  };
}

export function newListPayoutStripeTransferSuccessNotifyingTasksRequest(
  body: ListPayoutStripeTransferSuccessNotifyingTasksRequestBody,
): ClientRequestInterface<ListPayoutStripeTransferSuccessNotifyingTasksResponse> {
  return {
    descriptor: LIST_PAYOUT_STRIPE_TRANSFER_SUCCESS_NOTIFYING_TASKS,
    body,
  };
}
